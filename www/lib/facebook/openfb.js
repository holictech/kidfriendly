...
var openFB = (function () {
    ...
    // By default we store fbAccessToken in sessionStorage. This can be overridden in init()
    ...
    function init(params) {
        ...
        loginURL = params.loginURL || 'https://www.facebook.com/' + version + '/dialog/oauth';
        logoutURL = params.logoutURL || 'https://www.facebook.com/logout.php';
    ...
    function api(obj) {
        ...
        url = 'https://graph.facebook.com/' + version + obj.path + '?' + toQueryString(params);
