(function () {
  ...
  angular.module("ionic-multiselect", [])
    ...
    *   </multiselect>
    */
    .directive("multiselect", ["$ionicModal", "$ionicScrollDelegate", "multiselect", function($ionicModal, $ionicScrollDelegate, multiselect) {
      return {
        restrict: "E",
        ...
        link: function(scope, element, attrs) {
          ...
          */
          ...
          scope.quantitySelected = function() {
            return scope.text.length === 0 ? '' : scope.text.split('^').length + ' Selecionada(s)';
          };
